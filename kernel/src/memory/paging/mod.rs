...
pub trait PageExtension: Copy {
	fn l4_index(self) -> u64;
	fn l3_index(self) -> u64;
	fn l2_index(self) -> u64;
	fn l1_index(self) -> u64;
}

impl PageExtension for super::Page {
	fn l4_index(self) -> u64 { (self.0 & amd64::L4_MASK) >> amd64::L4_SHIFT }
	fn l3_index(self) -> u64 { (self.0 & amd64::L3_MASK) >> amd64::L3_SHIFT }
	fn l2_index(self) -> u64 { (self.0 & amd64::L2_MASK) >> amd64::L2_SHIFT }
	fn l1_index(self) -> u64 { (self.0 & amd64::L1_MASK) >> amd64::L1_SHIFT }
}
